...
public class loginpage extends javax.swing.JFrame {
    ...
    private void gett1()
    {
        try
        {
            ...
            rs=pst.executeQuery();
            twoTables.jTable1.setModel(DbUtils.resultSetToTableModel(rs));
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FOR EVENT MANAGERS:");

        jButton2.setBackground(new java.awt.Color(153, 255, 153));
        jButton2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton2.setForeground(new java.awt.Color(0, 102, 51));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/BackGreen.png"))); // NOI18N
        ...
        jLabel2.setText("for existing users:");

        jButton1.setBackground(new java.awt.Color(0, 204, 204));
        jButton1.setForeground(new java.awt.Color(102, 255, 204));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/login (1).jpg"))); // NOI18N
        ...
        private void check()
    {
        ...
        try
        {
            String query="select fname,password from emanager where fname=? and password=?";
            pst=conn.prepareStatement(query);
            ...
            if(rs.next())
            {
                ...
                twoTables pfive=new twoTables();
                loginpage.this.setVisible(false);
                pfive.setVisible(true);
                twoTables.jLabel2.setText(jTextField1.getText().toUpperCase());
                //gett1();
                //gett2();
            }
            else
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        eventManager pp=new eventManager();
        loginpage.this.setVisible(false);
        pp.setVisible(true);
